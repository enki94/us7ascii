...
public class Us7AsciiResultSet implements ResultSet {

    private final ResultSet delegate;

    public Us7AsciiResultSet(ResultSet delegate) {
    ...
    public Statement getStatement() throws SQLException {
        // Should return wrapped statement if possible, but we don't hold a ref to it.
        // It's okay to return the delegate's statement for now,
        // or we can wrap it on the fly, but that breaks identity equality.
        // Let's wrap it to be safe so if they use it to create more result sets, they
        // get wrapped ones.
        return new Us7AsciiStatement(delegate.getStatement());
    }
