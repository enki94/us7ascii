...
public class Us7AsciiPreparedStatement extends Us7AsciiStatement implements PreparedStatement {

    private final PreparedStatement delegatePs;

    public Us7AsciiPreparedStatement(PreparedStatement delegate) {
        super(delegate);
    ...
    public ResultSet executeQuery() throws SQLException {
        return new Us7AsciiResultSet(delegatePs.executeQuery());
    }
